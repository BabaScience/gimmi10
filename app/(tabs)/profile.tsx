...
import { Settings, UserPlus, LogOut, ChevronRight, Bell, Lock, CreditCard, Gift, CircleHelp as HelpCircle } from 'lucide-react-native';
...
export default function ProfileScreen() {
  const [currentSubscription, setCurrentSubscription] = useState<SubscriptionPlan>(SUBSCRIPTION_PLANS[1]); // Basic tier
        ...
        <Card title="Subscription" style={styles.subscriptionCard}>
          <View style={styles.subscriptionContent}>
            ...
            {currentSubscription.tier !== 'elite' && (
              <Button
                title={`Upgrade to ${
                  currentSubscription.tier === 'free' ? 'Basic' :
                  currentSubscription.tier === 'basic' ? 'Pro' : 'Elite'
                }`}
                variant="primary"
                style={styles.upgradeButton}
                onPress={() => {
                  const nextTierIndex = SUBSCRIPTION_PLANS.findIndex(
...
const styles = StyleSheet.create({
  ...
  subscriptionBadge: {
    backgroundColor: 
      currentSubscription => 
        currentSubscription.tier === 'free' ? Theme.colors.textSecondary :
        currentSubscription.tier === 'basic' ? Theme.colors.primary :
        currentSubscription.tier === 'pro' ? Theme.colors.secondary :
